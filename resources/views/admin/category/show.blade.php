...
<section class="content-header">
    ...
    <section class="content">
        <div>
            <td><a href="/admin/category/edit/{{$data->id}}" class="btn btn-primary btn-rounded btn-fw">Edit</a></td>
            <td><a href="/admin/category/delete/{{$data->id}}" class="btn btn-danger btn-rounded btn-fw">Delete</a></td>
        </div>
